    ...
    for (int i = 0; i < args.row_count; i++) {
        ...
        if (flag) {
            ...
            index++;
                ...
                strcpy(tmp_list[i], delete_space(list[i]));
        }
    }
    return(tmp_list);
    free(tmp_list);
    ...
    for (i = 0; i < args.row_count; i++) {
        ...
        if (flag == 1) {
            ...
            index++;
                ...
                strcpy(rez[i], delete_space(list[i]));
        }
    }
    rez[i]="\0";
    return(rez);
